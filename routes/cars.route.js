...
router.get('/userChoiceVehicle',async(req,res)=>{
    try{
        ...
        var date1 = moment(startDate).format('YYYY-MM-DDT23:59:59.000Z');
       ...
       let vehicleDetails = await category.aggregate([
        {
            $match:{
                ...
                $and:[
                     //{"uuid": 'CAT-539AD3F01DB6202241816917'},
                     //{'uuid':'CAT-E7E081CCD8FD1932022134321'},
                     {"userUuid": 'REG-A5C6745A783A'},
